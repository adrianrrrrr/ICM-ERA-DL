        ...
        for y_lat in range(0,5):
            for x_lon in range(0,10):
                ...
                if (x_lon == 2 or x_lon == 3 or x_lon == 7) and (y_lat == 4):
                    ...
                    '''
                    print('lon_id: (',x_lon,'); lat_id: ','(',y_lat,')','gets lons from: ',lon_position_from,'to ',lon_position_to,'and lats from: ',lat_position_from,
                        ' to: ',lat_position_to)
